...
class RolesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $user1 = User::create(['name' => 'Ghassan Zakaria', 'username' => 'ghassan', 'email' => 'ghassan@bloggi.test', 'mobile' => '966500000003', 'email_verified_at' => Carbon::now(), 'password' => bcrypt('123123123'), 'status' => 1,]);
        $user1->attachRole($userRole);

        $user2 = User::create(['name' => 'Alaa Taha', 'username' => 'alaa', 'email' => 'alaa@bloggi.test', 'mobile' => '966500000004', 'email_verified_at' => Carbon::now(), 'password' => bcrypt('123123123'), 'status' => 1,]);
        $user2->attachRole($userRole);

        $user3 = User::create(['name' => 'Mohammad Matar', 'username' => 'mohammad', 'email' => 'mohammad@bloggi.test', 'mobile' => '966500000005', 'email_verified_at' => Carbon::now(), 'password' => bcrypt('123123123'), 'status' => 1,]);
